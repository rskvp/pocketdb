...
func (a *Role) Query(ctx context.Context, params sch.RoleQueryParam) (*sch.RoleQueryResult, error) {
...
func (a *Role) Get(ctx context.Context, id string) (*sch.Role, error) {
	...
	roleMenuResult, err := a.RoleMenuDAL.Query(ctx, sch.RoleMenuQueryParam{
		RoleID: id,
	})
	if err != nil {
		return nil, err
...
func (a *Role) Create(ctx context.Context, formItem *sch.RoleForm) (*sch.Role, error) {
...
func (a *Role) Update(ctx context.Context, id string, formItem *sch.RoleForm) error {
	role, err := a.RoleDAL.Get(ctx, id)
	if err != nil {
		return err
	} else if role == nil {
